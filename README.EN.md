...
│
├── data/
│   ├── dataset_sidechains_curated.csv   # Human-readable dataset (residues, coords, χ angles)
│   └── dataset_torsional_diffusion.pt   # Serialised graphs for PyTorch Geometric
│
├── models/
│   └── chignn_best.pt            # Best model checkpoint (epoch 42)
│
├── results/
│   ├── figures/                  # Rose plots, learning curves, calibration plots
│   └── metrics/                  # MAE and rotamer recovery tables
│
└── docs/
